...
public class Level3 extends Level
{
    ...
    {
        //menambahkan objek player 3.
        Player3 player3 = new Player3();
        addObject(player3,311,365);
        player3.setLocation(401,260);
    }
    ...
    { 
        ...
        /*memanggil method untuk menghasilkan nilai acak antara 0 - 999, jika mendapatkan nilai acak < 3
           maka lanjut pernyataan dibawah.*/
        ...
        /*memanggil method untuk menghasilkan nilai acak antara 0 - 749, jika mendapatkan nilai acak < 3
           maka lanjut pernyataan dibawah.*/
        if(Greenfoot.getRandomNumber(750)<3){
            //menambahkan object Enemy3 dengan posisi"1000" dan mewakili posisi X dan 0-499 posisi Y.
            addObject(new Enemy3(),1000,Greenfoot.getRandomNumber(500));
        }
